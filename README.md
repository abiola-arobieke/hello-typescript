...
# 📖 [HELLO-TYPESCRIPT] <a name="about-project"></a>

**HELLO-TYPESCRIPT** is a practice project for understanding typescript programming langugae.
...
- **Implement the basic features of type-scprit**
- **Validate user input and display a list of data received**
- **Create a third party libraries with typescript**
...
```sh
  git clone https://github.com/abiola-arobieke/hello-typescript.git
```
...
```sh
  [Click to view the backend](https://github.com/abiola-arobieke/hello-typescript.git)
```
...
Feel free to check the [issues page](https://github.com/abiola-arobieke/hello-typescript/issues).
